...
根据三相全控桥的纹波要求，平波电感 Ld 由下式确定：

**Ld ≈ Uripple(6f) / (6·ω·ΔId)**

其中：
- **Uripple(6f)**：直流电压中6倍频纹波分量的峰值（V）
- **ω = 2πf**：电网角频率（rad/s）
- **ΔId = 20%·Id**：允许的电流纹波幅度（A）

**参数取值：**
- 纹波电压：Uripple(6f) = 30 V（从仿真波形读取）
- 直流电流：Id = 6 A，ΔId = 0.2 × 6 = 1.2 A
- 电网频率：f = 50 Hz，ω = 2π × 50 ≈ 314.16 rad/s

**计算结果：**
**Ld ≈ 30 / (6 × 314.16 × 1.2) ≈ 0.05 H**
